...
public partial class SFRTT : MonoBehaviour
{
    ...
    public virtual void Start()
    {
        ...
        if (!RenderTexture)
        {
            RenderTexture = new RenderTexture(RenderTextureWidth, RenderTextureHeight, 0, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Default);
            RenderTexture.Create();
    ...
    {
        UnityEngine.Debug.Log("In Destroy");
    ...
    */
    ...
    public bool CreateRenderMovie(SFCamera camera, Type movieClassType)
    {
        ...
        if (RTTMovie == null || RTTMovie.MovieID == 0)
        {
            if (camera)
            {
                UnityEngine.Debug.Log("Creating movie");
